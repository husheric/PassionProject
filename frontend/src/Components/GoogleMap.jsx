...
// 	render() {
// 		const { center, zoom, draggable, newReport, selected, markers, onNewReport, onChange, onMarkerDrag, onChildMouseDown, onChildMouseUp, onChildClick, onFormChange, onFormSubmit, sidebarIsOpen, markerFilters } = this.props;
// 		console.log(this.state)
// 		console.log(center)
// 		// [37.775, -122.434]

// 		if (this.state.heatData.length > 0) {
// 			return (
// 				<div style={{ width: '90vw', height: '90vh' }}>
// 		      <GoogleMap
// 		      	bootstrapURLKeys={{ libraries: 'visualization', key: google_map_api_key }}
